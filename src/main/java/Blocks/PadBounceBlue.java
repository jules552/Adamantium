...
public class PadBounceBlue extends BlockBreakable{
	...
	public PadBounceBlue() {
	 ...
	 @SideOnly(Side.CLIENT)
	    ...
	    { 
	            entityIn.motionY = 1.5D+entityIn.motionY; 
	    }
	    ...
	    {
	        return Item.getItemFromBlock(BlocksMod.BOUNCE_PAD_BLUE);
	    }

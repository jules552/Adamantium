...
public class PadBounceGreen extends BlockBreakable{
	...
	public PadBounceGreen() {
	 ...
	 @SideOnly(Side.CLIENT)
	    ...
	    { 
	            entityIn.motionY = 1.2D+entityIn.motionY; 
	    }
	    ...
	    {
	        return Item.getItemFromBlock(BlocksMod.BOUNCE_PAD_GREEN);
	    }
